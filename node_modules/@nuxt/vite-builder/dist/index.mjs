import { o as __toESM } from "./_chunks/rolldown-runtime.mjs";
...
function DecoratorsPlugin(nuxt) {
	...
	return {
		...
		async applyToEnvironment() {
			...
			transformSync = await import("./_chunks/libs/@babel/core.mjs").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)).then((r) => r.transformSync);
			return true;
		},
		transform: {
			filter: {
